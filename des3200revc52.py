...
class DES3200RevC52(DES3200RevC):

    def __init__(self, parameters):
        super().__init__(parameters)

    input_wait_string = b'DES-3200-52:admin#'
    ...
    def configure_lbd(self):
        ...
        self.make_instruction('config loopdetect ports 1-48 state enable')
    ...
    def configure_dhcp_filter(self):
        ...
        self.make_instruction('config filter dhcp_server ports 1-48 state enable')
    ...
    def configure_traffic_control(self):
        ...
        self.make_instruction('config traffic control 1-48 broadcast enable')
        self.make_instruction('config traffic control 1-48 multicast enable')
        self.make_instruction('config traffic control 1-48 unicast enable')
    ...
    def configure_traffic_segmentation(self):
        ...
        self.make_instruction('config traffic_segmentation 1-48 forward_list 48-52')
        self.make_instruction('config traffic_segmentation 48-52 forward_list 1-52')
    ...
    def configure_mgm_vlan(self):
        ...
        if int(self.mgm_vlan) == int(1):
            self.make_instruction('config vlan default delete 1-48')
            self.make_instruction('config vlan default add tagged 48-52')
        else:
            self.make_instruction('create vlan mgm_' + self.mgm_vlan + ' tag ' + self.mgm_vlan)
            self.make_instruction('config vlan mgm_' + self.mgm_vlan + ' add tagged 48-52')
    ...
    def configure_users_vlan(self):
        ...
        self.make_instruction('config vlan vlan' + self.user_vlan + ' add tagged 48-52')
        self.make_instruction('config vlan vlan' + self.user_vlan + ' add untagged 1-48')
    ...
    def delete_default_vlan(self):
        ...
        if int(self.mgm_vlan) != int(1):
            ...
            self.make_instruction('config vlan default delete 1-52')
