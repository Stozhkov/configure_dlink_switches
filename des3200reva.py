...
class DES3200RevA(DlinkSwitch):
    ...
    def upgrade_firmware(self):
        ...
        self.make_instruction('download firmware_fromTFTP ' + self.__server_ip + ' DES3200R189B02 image_id 1\n\ry')
    ...
    def configure_syslog(self):
        ...
        self.make_instruction('create syslog host 1 ipaddress 10.0.2.45 udp_port 514 severity all state enable')
